...
INSERT INTO `pedido` (`id_pedido`, `data`, `valor`, `tipo`, `desconto`, `acrescimo`) VALUES
	...
	(21, '2019-12-08 21:47:04', 318.90, 'Dinheiro', 0.00, 0.00),
	(22, '2019-12-08 21:57:22', 264.40, 'Dinheiro', 0.00, 0.00),
	(23, '2019-12-08 22:00:30', 50.00, 'Dinheiro', 0.00, 0.00),
	(24, '2019-12-08 22:07:23', 268.90, 'Dinheiro', 0.00, 0.00),
	(25, '2019-12-08 22:19:14', 268.90, 'Dinheiro', 0.00, 0.00),
	(26, '2019-12-08 23:48:28', 533.30, 'Dinheiro', 0.00, 0.00),
	(27, '2019-12-08 23:51:29', 50.00, 'Debito', 0.00, 0.00),
	(28, '2019-12-08 23:54:21', 195.00, 'Credito', 0.00, 0.00),
	(29, '2019-12-09 00:00:19', 110.00, 'Credito', 0.00, 0.00),
	(30, '2019-12-09 00:00:43', 50.00, 'Credito', 0.00, 0.00),
	(31, '2019-12-09 00:02:03', 30.00, 'Credito', 0.00, 0.00),
	(32, '2019-12-09 00:04:00', 129.95, 'Credito', 0.00, 0.00),
	(33, '2019-12-09 00:15:02', 129.95, 'Dinheiro', 0.00, 0.00),
	(34, '2019-12-09 00:15:28', 110.00, 'Dinheiro', 0.00, 0.00),
	(35, '2019-12-09 00:23:10', 125.00, 'Dinheiro', 0.00, 0.00),
	(36, '2019-12-09 00:23:44', 90.00, 'Credito', 0.00, 0.00),
	(37, '2019-12-09 00:25:04', 84.00, 'Debito', 0.00, 0.00),
	(38, '2019-12-09 00:30:20', 70.00, 'Debito', 0.00, 0.00),
	(39, '2019-12-09 00:31:16', 326.98, 'Debito', 0.00, 0.00),
	(40, '2019-12-09 00:40:07', 77.97, 'Dinheiro', 0.00, 0.00),
	(41, '2019-12-09 00:40:33', 126.98, 'Dinheiro', 0.00, 0.00),
	(42, '2019-12-09 00:41:24', 43.50, 'Dinheiro', 0.00, 0.00),
	(43, '2019-12-09 00:43:09', 50.00, 'Credito', 0.00, 0.00),
	(44, '2019-12-09 00:43:54', 144.00, 'Credito', 0.00, 0.00),
	(45, '2019-12-09 00:45:06', 165.00, 'Dinheiro', 0.00, 0.00),
	(46, '2019-12-09 00:48:30', 125.00, 'Debito', 0.00, 0.00),
	(47, '2019-12-09 00:48:57', 51.98, 'Credito', 0.00, 0.00),
	(48, '2019-12-09 00:49:50', 50.00, 'Dinheiro', 0.00, 0.00),
	(49, '2019-12-09 00:50:19', 60.00, 'Debito', 0.00, 0.00),
	(50, '2019-12-09 00:54:31', 179.95, 'Debito', 0.00, 0.00),
	(51, '2019-12-09 01:07:33', 50.00, 'Dinheiro', 0.00, 0.00),
	(52, '2019-12-09 01:08:12', 155.00, 'Dinheiro', 0.00, 0.00),
	(53, '2019-12-09 01:11:48', 25.00, 'Debito', 0.00, 0.00),
	(54, '2019-12-09 01:13:10', 200.00, 'Dinheiro', 0.00, 0.00),
	(55, '2019-12-09 01:15:49', 544.90, 'Credito', 0.00, 0.00),
	(56, '2019-12-09 01:21:26', 50.00, 'Dinheiro', 0.00, 0.00),
	(57, '2019-12-09 01:22:17', 333.40, 'Debito', 0.00, 0.00),
	(58, '2019-12-09 01:24:43', 779.80, 'Credito', 0.00, 0.00),
	(59, '2019-12-09 01:29:01', 2177.15, 'Credito', 0.00, 0.00),
	(60, '2019-12-09 02:20:21', 67.50, 'Dinheiro', 0.00, 0.00),
	(61, '2019-12-09 02:20:56', 140.00, 'Dinheiro', 0.00, 0.00);
...
INSERT INTO `produto` (`id_produto`, `nome`, `marca`, `imagem`, `preco`, `custo`, `quantia`, `quantia_minima`, `tipo`, `status`) VALUES
	...
	(4, 'Dolly 2l Guarana', 'Dolly', '../../img/produto/ae74d3577951d113fc5a1b79f16af012.jpg', 4.50, 2.30, 0, 5, 'Comum', 'Ativo'),
...
CREATE TABLE `devedores` (
	...
	`nome_cliente` VARCHAR(45) NOT NULL COLLATE 'utf8_bin',
	`situacao` VARCHAR(9) NOT NULL COMMENT 'Diz se o cliente tem dividas ativas.' COLLATE 'utf8_bin',
	`descricao` VARCHAR(200) NULL COLLATE 'utf8_bin',
	`data_cliente` TIMESTAMP NOT NULL COMMENT 'data do cadastro do cliente',
	`status_cliente` VARCHAR(8) NOT NULL COMMENT 'Diz se o cliente está ativo ou desativo' COLLATE 'utf8_bin',
	`tipo_cliente` VARCHAR(6) NOT NULL COMMENT 'se o cliente é mensal ou comum' COLLATE 'utf8_bin',
	`divida` DECIMAL(29,2) NOT NULL
) ENGINE=MyISAM;

-- Copiando estrutura para view mamaezona.pratos_cozinha
-- Criando tabela temporária para evitar erros de dependência de VIEW
CREATE TABLE `pratos_cozinha` (
	...
	`path_img_produto` VARCHAR(255) NOT NULL COLLATE 'utf8_general_ci',
